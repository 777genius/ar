...
const cases = [
  ...
  },
  {
    ...
    files: {
      "src/account-diagnostics/good.ts": "import type { WorkerAccountCapacityStore } from '@777genius/subscription-runtime/worker-core';\n",
    },
    expectPass: true,
  },
  {
    ...
    files: {
      "src/account-diagnostics/bad.ts": "import '@777genius/subscription-runtime/provider-codex';\n",
    },
    expectPass: false,
    expectText:
