...
try {
  ...
  await writeFile(
    ...
    [
      ...
      "import { createAgentTaskRequest } from '@777genius/subscription-runtime/agent-task';",
      "import { ClaudeBgProviderDriver, ClaudeRuntimeTaskExecutionEngine } from '@777genius/subscription-runtime/provider-claude';",
      "import { FileBackendCodexWorker, callCodexGoalMcpTool, doctorCodexGoalControlSurface } from '@777genius/subscription-runtime/worker-codex';",
      "import { FileBackendClaudeWorker } from '@777genius/subscription-runtime/worker-claude';",
  ...
  await writeFile(
    ...
    [
      "import { createSubscriptionRuntime, DefaultRedactor, type RunnerPort } from '@777genius/subscription-runtime/core';",
      "import { createAgentTaskRequest, runAgentTaskBridge } from '@777genius/subscription-runtime/agent-task';",
      "import { ClaudeBgProviderDriver, ClaudeRuntimeTaskExecutionEngine, sessionArtifactFromClaudeOAuth } from '@777genius/subscription-runtime/provider-claude';",
      "import { FileBackendCodexWorker, callCodexGoalMcpTool, doctorCodexGoalControlSurface, listCodexGoalMcpTools } from '@777genius/subscription-runtime/worker-codex';",
      "import { FileBackendClaudeWorker } from '@777genius/subscription-runtime/worker-claude';",
      "import { createLocalFileBackendRuntimeAdapters } from '@777genius/subscription-runtime/store-local-file';",
