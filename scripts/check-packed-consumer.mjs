...
try {
  ...
  await writeFile(
    ...
    [
      ...
      "import { ClaudeBgProviderDriver, ClaudeCliTaskExecutionEngine, ClaudeRuntimeTaskExecutionEngine } from '@777genius/subscription-runtime/provider-claude';",
      ...
      "if (typeof ClaudeCliTaskExecutionEngine !== 'function') throw new Error('missing claude CLI engine export');",
  ...
  await writeFile(
    ...
    [
      ...
      "import { ClaudeBgProviderDriver, ClaudeCliTaskExecutionEngine, ClaudeRuntimeTaskExecutionEngine, sessionArtifactFromClaudeOAuth } from '@777genius/subscription-runtime/provider-claude';",
      "import { FileBackendCodexWorker } from '@777genius/subscription-runtime/worker-codex';",
      "import { FileBackendClaudeWorker } from '@777genius/subscription-runtime/worker-claude';",
      "import { createLocalFileBackendRuntimeAdapters } from '@777genius/subscription-runtime/store-local-file';",
      ...
      "void ClaudeCliTaskExecutionEngine;",
