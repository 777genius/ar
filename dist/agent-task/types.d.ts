...
export type AgentTaskRunFunction = (request: AgentTaskRequest, context: AgentTaskHandlerContext) => Promise<AgentTaskHandlerResult> | AgentTaskHandlerResult;
export type AgentTaskStreamFunction = (request: AgentTaskRequest, context: AgentTaskHandlerContext) => AsyncIterable<AgentTaskEvent | ProviderTaskEvent>;
...
export type AgentTaskProtocolErrorCode = "agent_task_protocol_version_invalid" | "agent_task_request_invalid" | "agent_task_result_invalid" | "agent_task_event_invalid" | "agent_task_handler_invalid" | "agent_task_json_invalid";
export declare class AgentTaskProtocolError extends Error {
    readonly code: AgentTaskProtocolErrorCode;
    constructor(code: AgentTaskProtocolErrorCode, safeMessage: string);
}
export declare function makeAgentTaskFailure(code: ProviderFailureCode, safeMessage: string, input?: {
