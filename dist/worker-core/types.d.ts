...
export type WorkerSlotAvailability = "available" | "busy" | "warming" | "cooldown" | "quota_exhausted" | "degraded" | "disabled";
...
export interface CapacityAwareSubscriptionWorker<Job, Result> extends SubscriptionWorker<Job, Result> {
