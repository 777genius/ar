...
function mapPermissionMode(
  ...
  if (permissionMode === "allow-edits") return "acceptEdits";
  if (permissionMode === "bypass") return "bypassPermissions";
  if (permissionMode === "read-only" || permissionMode === "preapproved") {
    return "dontAsk";
  }
  return "default";
}
